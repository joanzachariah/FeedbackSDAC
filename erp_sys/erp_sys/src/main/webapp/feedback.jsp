...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .sidebar { height: 100vh; background-color: #48207d; color: white; padding-top: 20px; position: fixed; }
      .sidebar .nav-link { color: #ecf0f1; transition: all 0.3s ease; border-radius: 5px; margin-bottom: 5px; }
      .sidebar .nav-link:hover, .sidebar .nav-link.active { background-color: #cbc3e3; color: #fff; }

     .content-header { background-color: #ecf0f1; padding: 15px 20px; border-bottom: 1px solid #bdc3c7; }
      .container-fluid {
        padding: 0;
      }
      .col-md-9.col-lg-10.p-0 {
    margin-left: 16.666667%; /* For md screens - matches col-md-3 */
}

@media (min-width: 992px) {
    .col-md-9.col-lg-10.p-0 {
        margin-left: 16.666667%; /* For lg screens - matches col-lg-2 */
    }
}
...
.main-content {
    ...
    overflow-y: auto; /* Add this */
      ...
      tbody {
        display: block;
        max-height: 150px; /* Show 3 items at a time */
        overflow-y: scroll;
        width: 100%;
      }
      ...
      .ratings-chart-container canvas {
        max-width: 600px; /* Increase the chart size */
        margin: 0 auto;
      }
      .navbar-brand {
        font-weight: bold;
      ...
      <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 sidebar d-flex flex-column p-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="FeedbackServlet">
        ...
        <div class="col-md-9 col-lg-10 p-0">
          ...
          <div class="main-content" id="main-content">
            ...
            <div class="ratings-chart-container">
              ...
              <canvas id="ratingsChart" style="max-width: 800px; height: 400px;"></canvas>
              <script>
                ...
                var ratingsData = {
                  ...
                  datasets: [{
                    ...
                    data: ratingsCount,
                    backgroundColor: ['#a275de', '#8358be', '#623f91', '#4c2f73', '#341d52'], 
                    borderColor: ['#a275de', '#8358be', '#623f91', '#4c2f73', '#341d52'],
                    borderWidth: 1
                  }]
                };
